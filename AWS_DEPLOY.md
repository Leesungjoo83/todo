...
확인 -----------------------------------
ubuntu@ip-172-31-44-73:~/todo_AWS$ node server.js
🚀 서버가 http://localhost:3000 에서 실행 중입니다.
✅ MariaDB 연결 성공
^Z
[1]+  Stopped                 node server.js
ubuntu@ip-172-31-44-73:~/todo_AWS$
---------------------------------------
# 정상 작동 확인 후 Ctrl+C로 중지
확인-----------------------------------
[]ubuntu@ip-172-31-44-73:~$ ^C
---------------------------------------
```
...
확인 --------------------------------
ubuntu@ip-172-31-44-73:~/todo_AWS$ pm2 start server.js --name todo-app
[PM2] Starting /home/ubuntu/todo_AWS/server.js in fork_mode (1 instance)
[PM2] Done.
┌────┬────────────────────┬──────────┬──────┬───────────┬──────────┬──────────┐
│ id │ name               │ mode     │ ↺    │ status    │ cpu      │ memory   │
├────┼────────────────────┼──────────┼──────┼───────────┼──────────┼──────────┤
│ 0  │ todo-app           │ fork     │ 0    │ online    │ 0%       │ 9.6mb    │
└────┴────────────────────┴──────────┴──────┴───────────┴──────────┴──────────┘
ubuntu@ip-172-31-44-73:~/todo_AWS$ ^C
ubuntu@ip-172-31-44-73:~/todo_AWS$
------------------------------------------
